...
M.setup = function()
  ...
  local groups = {
    ...
    TabLineSel = { fg = colors.dgreen, bg = colors.bg0, bold = config.bold },
    ...
    -- nvim-tree
    NvimTreeSymlink = { fg = colors.daqua },
    NvimTreeRootFolder = { fg = colors.dpurple, bold = true },
    NvimTreeFolderIcon = { fg = colors.dblue, bold = true },
    NvimTreeFileIcon = { fg = colors.fg2 },
    NvimTreeExecFile = { fg = colors.dgreen, bold = true },
    NvimTreeOpenedFile = { fg = colors.bright_red, bold = true },
    NvimTreeSpecialFile = { fg = colors.dyellow, bold = true, underline = true },
    NvimTreeImageFile = { fg = colors.dpurple },
    NvimTreeIndentMarker = { fg = colors.bg3 },
    NvimTreeGitDirty = { fg = colors.dyellow },
    NvimTreeGitStaged = { fg = colors.dyellow },
    NvimTreeGitMerge = { fg = colors.dpurple },
    NvimTreeGitRenamed = { fg = colors.dpurple },
    NvimTreeGitNew = { fg = colors.dyellow },
    NvimTreeGitDeleted = { fg = colors.dred },
